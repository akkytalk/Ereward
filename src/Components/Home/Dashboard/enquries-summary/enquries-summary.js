...
function EnquriesSummary(props) {
  //token
    ...
    datasets: [
      {
        ...
        data: props?.allStats?.allStats?.enquiries?.map((o) => ({
          y: o.count,
          x: o.Created_Day,
        })),
        // data: [1, 2, 5, 7, 8, 10],
...
export default connect(mapStateToProps, mapPropsToDispatch)(EnquriesSummary);
